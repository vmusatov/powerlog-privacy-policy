...
- __Application__ refers to Power Log, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Power Log.
...
Future features such as account creation and cloud sync may involve collecting:
- Name (optional)
